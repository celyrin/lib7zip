...
static std::list<std::wstring> g_lib7zip_sfx_handler_names;
...
const std::list<std::wstring>& GetLib7ZipSfxHandlerNames()
{
    return g_lib7zip_sfx_handler_names;
}

void SetLib7ZipSfxHandlerNames(const std::list<std::wstring>& listNames)
{
    g_lib7zip_sfx_handler_names = listNames;
}
